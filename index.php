      ...
      <div class="col-12 col-lg-8">
        ...
        <div id="FoodCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img class="d-block w-100" src="img/slide003.jpg" alt="">
              <div class="carousel-caption d-none d-md-block">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12 col-sm-6 col-lg-4">
              <figure class="figure shadow-lg p-3">
                <img src="img/Chapati...jpg" class="figure-img img-fluid img-thumbnail" alt="figure-image">
                <figcaption class="figure-caption">
                  <p class="text-center font-weight-bolder">Chapati...</p>
                </figcaption>
              </figure>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
              <figure class="figure shadow-lg p-3">
                <img src="img/ugali-fish.jpg" class="figure-img img-fluid img-thumbnail" alt="figure-image">
                <figcaption class="figure-caption">
                  <p class="text-center font-weight-bolder">Ugali-fish</p>
                </figcaption>
              </figure>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
              <figure class="figure shadow-lg p-3">
                <img src="img/chicken720.jpg" class="figure-img img-fluid img-thumbnail" alt="figure-image">
                <figcaption class="figure-caption">
                  <p class="text-center font-weight-bolder">Grill-Chicken</p>
                </figcaption>
              </figure>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
              <figure class="figure shadow-lg p-3">
                <img src="img/samosa.jpg" class="figure-img img-fluid img-thumbnail" alt="figure-image">
                <figcaption class="figure-caption">
                  <p class="text-center font-weight-bolder">Samosa</p>
                </figcaption>
              </figure>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
              <figure class="figure shadow-lg p-3">
                <img src="img/chips.jpg" class="figure-img img-fluid img-thumbnail" alt="figure-image">
                <figcaption class="figure-caption">
                  <p class="text-center font-weight-bolder">Fries</p>
                </figcaption>
              </figure>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
              <figure class="figure shadow-lg p-3">
                <img src="img/Mukimo.jpg" class="figure-img img-fluid img-thumbnail" alt="figure-image">
                <figcaption class="figure-caption">
                  <p class="text-center font-weight-bolder">Mukimo</p>
                </figcaption>
              </figure>
            </div>
          </div>
